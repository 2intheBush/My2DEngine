...
void Path::Dijkstra(Node* start, Node* goal, Graph &grid)
{
...
bool Path::IsStraightLine(Node* begin, Node* end, Graph &grid)
{
...
glm::vec2 Path::RayDirection(glm::vec2& startPos, glm::vec2& endPos)
{
	return glm::normalize(endPos - startPos);
}

void Path::GetNodesInLine(std::vector<Node*> &v, Ray ray, Node* end, Graph &grid)
{
...
bool Path::AABBRayCollision(Ray& ray, Box b)
{
